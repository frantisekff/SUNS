...
with graph.as_default():
    ...
    loss = tf.reduce_mean(loss + beta[counter_beta] * regularizers)
...
for i in range(len(beta)):
    ...
    with tf.Session(graph=graph) as session:
        ...
        print("Initialized")
        print("pre Beta: " + format(beta[counter_beta]))
        ...
        test_accuracy[beta[counter_beta]] = temp_test
...
createGraph(test_accuracy.keys(), test_accuracy.values(), 'Úspešnosť trénovania pre testovacie dáta', 'Pravdepodobnosť','Beta')
